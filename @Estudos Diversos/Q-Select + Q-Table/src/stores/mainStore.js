...
export const useMainStore = defineStore('main', {
  state: () => ({
    ...
    arrayOfObjects: [
      ...
      { arma:'arma', especie:'especie1', marca:'marca1', modelo:'modelo1', situacao:'C', id: 2 },
      ...
      { arma:'pistola', especie:'especie3', marca:'marca2', modelo:'modelo2', situacao:'A', id: 15 },
      { arma:'zabata', especie:'especie3', marca:'marca2', modelo:'modelo3', situacao:'B', id: 6 },
